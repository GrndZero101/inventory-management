...
/* success/danger status colors are semantic - kept as literals */
...
/* 28px has no close token (equidistant between space-6/24px and space-7/32px) - left as literal */
.chart-card {
...
/* 12px dot size and 3px radius have no close tokens - left as literals */
.legend-dot {
  width: 12px;
  height: 12px;
  border-radius: 3px;
...
/* cost-category and revenue-vs-cost comparison colors are semantic - kept as literals */
...
/* revenue/cost/profit border colors form a matched semantic triad (mirrors the
   revenue-color/cost-color chart legend) - kept as literals even though profit's
   blue happens to match --color-accent */
.revenue-card {
...
.revenue-bars {
  ...
  max-width: 80px;
  display: flex;
  /* 6px gap has no close token (equidistant between space-1/4px and space-2/8px) - left as literal */
  gap: 6px;
...
/* revenue-vs-cost comparison colors are semantic - kept as literals */
.revenue-bar {
  background: #0f172a;
}
...
/* cost-category chart colors are semantic - kept as literals */
...
/* converges to the site-wide table cell padding (space-2 space-3) - 2px difference from the prior 10px is imperceptible */
