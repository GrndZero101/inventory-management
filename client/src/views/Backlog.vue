          ...
          <table>
            ...
            <tbody>
              <tr v-for="item in backlogItems" :key="item.id">
                ...
                <td>
                  <span :class="['delay', item.days_delayed > 7 ? 'delay-severe' : 'delay-moderate']">
...
export default {
  ...
  setup() {
    ...
    // Case-insensitive lookup into the shared priority.* locale keys (mirrors Dashboard.vue's translatePriority)
