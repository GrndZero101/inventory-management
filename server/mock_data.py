...
# Restock orders are created at runtime (not seed data), so this starts empty
# and, like everything else here, resets on server restart.
restock_orders = []

# Tasks are created at runtime (not seed data), so this starts empty
# and, like everything else here, resets on server restart.
tasks = []
